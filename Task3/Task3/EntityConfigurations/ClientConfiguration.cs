...
namespace Task3.EntityConfigurations
{
    public class ClientConfiguration : IEntityTypeConfiguration<Client>
    {
        public void Configure(EntityTypeBuilder<Client> builder)
        {
            ...
            builder.Property(c => c.PhoneNumber).IsRequired().HasColumnName("HiredDate").HasMaxLength(50);
            builder.Property(c => c.Description).HasColumnName("DateofBirth").HasMaxLength(50);
        }
    }
}
